...
- **Major comments**：8–10 条（涉及逻辑、理论、方法论、贡献等根本性问题）。每条 Major 意见必须**尽可能具体**：引用论文中的具体段落/行号/表格/图号，指出具体哪句话或哪个论证有问题，给出明确的改进方向。禁止泛泛而谈（如"introduction needs improvement"），必须说清楚**哪里**有问题、**为什么**有问题、**怎么**改。
- **Minor comments**：4–5 条（术语、格式、表述、引文等细节问题）
